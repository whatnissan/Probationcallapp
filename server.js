...
// Pure logic extracted to lib/ for unit testing (test/). detection.js
// exports the shared FTBEND_MISRECOGNITIONS object that doCrossCheck
// mutates at runtime — same single-reference behavior as before the split.
const {
...
// Color/phase lists + detectColor moved to lib/detection.js
...
// KEYWORDS, PIN_EXPIRED_PHRASES, detectPinExpired moved to lib/detection.js
...
// formatLocalDay, todayMD, wouldExceedCutoff, wouldExceedFtbendCutoff moved to lib/time.js
...
// detectPhaseColors moved to lib/detection.js
...
// computeTieredPriceCents and MAX_EXACT_CREDITS moved to lib/pricing.js
